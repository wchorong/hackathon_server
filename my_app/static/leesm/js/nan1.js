...
function next1(nowid,nextid) {
  $("#" + nowid).hide()
  $("#" + nextid).show()
  myFunction()
  document.getElementById("contentbox").style.zIndex = 2;
  // document.getElementById("contentbox").style.zIndex = 1;

}
function next2(nowid,nextid) {
  $("#" + nowid).hide()
  $("#" + nextid).show()
  myFunction()
  document.getElementById("contentbox").style.zIndex = 1;
  document.getElementById("datebox").style.zIndex = 2;

}

function next3(nowid,nextid) {
  $("#" + nowid).hide()
  $("#" + nextid).show()
  myFunction()
  document.getElementById("datebox").style.zIndex = 1;
  document.getElementById("time").style.zIndex = 2;
...
function showdate() {
  $("#pop_info_1").show()
  document.getElementById("tuto3").style.height = "530px";
  document.getElementById("tuto3").style.marginTop = "-120px";
  const element = document.getElementById("time");
  element.scrollIntoView();
}
function showtime() {
  $("#pop_info_2").show()
  document.getElementById("tuto4").style.height = "700px";
  document.getElementById("tuto4").style.marginTop = "-120px";
  const element = document.getElementById("time");
  element.scrollIntoView();
}
function clicktime(time) {
  ...
  $("#pop_info_2").show()
  document.getElementById("tuto4").style.height = "150px";
  document.getElementById("tuto4").style.marginTop = "350px";
  const element = document.getElementById("time");
  element.scrollIntoView();
  $("#pop_info_2").hide()  
}
...
function clickdate(year,month,date) {
  ...
  document.getElementById("tuto3").style.height = "150px";
  document.getElementById("tuto3").style.marginTop = "200px";
  const element = document.getElementById("time");
  element.scrollIntoView();
  $("#pop_info_1").hide() 
